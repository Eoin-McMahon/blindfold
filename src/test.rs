...
mod test {
    ...
    fn http_get() {
        ...
        assert_ne!(
            blindfold::http_get(
                "https://api.github.com/repos/toptal/gitignore/\
    ...
    fn coalesece_globstars() {
        ...
        for (path, correct_reduction) in path_reduction_map {
            ...
            assert_eq!(&reduction, correct_reduction);
        }
    }
    ...
    fn generate_gitignore_file() {
        ...
        map.insert(
            String::from("rust"),
            String::from(
                "https://raw.githubusercontent.com/toptal/gitignore/\
    ...
    fn suggest_most_similar() {
        ...
        let yes_answer =
            blindfold::suggest_most_similar(&yes_input[..], &mut output, &language, map.clone());

        let no_answer =
            blindfold::suggest_most_similar(&no_input[..], &mut output, &language, map.clone());

        let yes_answer_dissimilar = blindfold::suggest_most_similar(
            &yes_input[..],
            &mut output,
            &dissimilar_language,
            map.clone(),
